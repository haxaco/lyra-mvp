...
export default function AuthOnboardingBootstrapPage() {
  ...
  React.useEffect(() => {
    ...
    async function checkOnboardingStatus() {
      try {
        ...
        console.error('[onboarding/bootstrap] Error checking onboarding status:', error);
  ...
  const handleComplete = React.useCallback(async () => {
    try {
      ...
      console.error('[onboarding/bootstrap] Error completing onboarding:', error);
